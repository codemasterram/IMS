...
namespace SoftIms.Data.Helper
{
    public class ImsReportService
    {
        ...
        public ItemRecordViewModel GetItemRecord(int? itemId, int fiscalYearId)
        {
            ...
            if (itemId.HasValue)
            {
                var item = db.ItemRepo.GetById(itemId.Value);
                ...
                //Opening Stock
                var OpeningStock = (from t1 in db.StockTransactionRepo.Table()
            ...
            if (itemId.HasValue)
            {
                ...
                var OpeningStock = (from t1 in db.StockTransactionRepo.Table()
                                    ...
                                    select new
                                    {
                                        ...
                                        DepartmentName = t2.Department.Name
                                    }).ToList();
                ...
                if (OpeningStock != null)
                {
                    foreach (var _openingstock in OpeningStock)
                    {
                        ...
                        storeEntryData.DepartmentId = _openingstock.DepartmentId;
                        storeEntryData.DepartmentName = _openingstock.DepartmentName;
                ...
                if (stockEntry != null)
                {
                    ...
                    {
                        var storeEntryData = new ItemSubRecordDetailViewModel();
                        storeEntryData.DepartmentId = _storeentry.DepartmentId;
                        storeEntryData.DepartmentName = _storeentry.DepartmentName;
                ...
                if (stockAdjustment != null)
                {
                    foreach (var _stockadjustment in stockAdjustment)
                    {
                        ...
                        stockAdjustmentData.DepartmentId = _stockadjustment.DepartmentId;
                        stockAdjustmentData.DepartmentName = _stockadjustment.DepartmentName;
                ...
                if (itemRelease != null)
                {
                    foreach (var _itemRelease in itemRelease)
                    {
                        ...
                        itemReleaseData.DepartmentId = _itemRelease.DepartmentId;
                        itemReleaseData.DepartmentName = _itemRelease.DepartmentName;
        ...
        //{
        //    var data = db.Table.Where(x => x.ItemLedgerMaster.Code == itemCode);
        ...
        {
            return db.ItemRepo.Table().Where(x => x.Code == itemCode).FirstOrDefault().Name;
        }
