...
namespace SoftIms.Data
{
    public class UnitOfWork : IDisposable
    {
        ...
        public IEnumerable<T> SqlQuery<T>(string query, DbParameter[] p)
        {
            return _context.Database.SqlQuery<T>(query, p);
        }

        public System.Data.Entity.DbSet<T> Table<T>() where T: class
        {
